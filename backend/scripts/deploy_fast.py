...
tx = manager.mintPost(userId1, username1, "all", "some title", "some text", "a link", from_dict1)
...
tx = manager.makeComment(userId2, username2, "a comment", "another link", postId, True, from_dict2)
